...
- **J&S** continue their European trip

---

## Day-by-day sketch

The stops below are listed Bergen → Alesund (northbound). If you go southbound, read them in reverse.
...
- Bergen has excellent vegetarian restaurants and a strong food scene

### Stop 2: Sognefjord / Flam (2N)

- Drive or train to Flam via the scenic route
- **Flam Railway** — one of the world's most scenic train rides
- **Aurlandsfjord kayaking** — calm water, towering walls
...
- Drive to/from Alesund (~2.5h from Geiranger via the **Trollstigen** road if open — one of Norway's most famous mountain passes with hairpin bends and waterfalls)
...
The stops are the same either way. The real question is: where do you want the harder logistics — at the start or the end?

### Northbound: Bergen → Alesund

- **Fly into Bergen** (one connection from SFO, easy)
- **Split from Alesund** (fewer flight options, P&L need to connect via Oslo to reach Lofoten)
- Trip arc: starts mellow in a city, builds toward more dramatic scenery
- The harder logistics hit at the end, when people are splitting in different directions

### Southbound: Alesund → Bergen

- **Fly into Alesund** (double connection from SFO — adds 2–4 hours)
- **Split from Bergen** (excellent connections everywhere, P&L fly direct to Bodo for Lofoten)
- Trip arc: starts with the dramatic scenery while energy is high, winds down in Bergen
- The harder logistics hit at the start, when everyone is together and can deal with it as a group

### Side-by-side

| | Northbound (Bergen → Alesund) | Southbound (Alesund → Bergen) |
|---|---|---|
| Inbound flight | 1 connection, easier | 2 connections, 2–4h longer |
| P&L → Lofoten | Via Oslo, ~$150–300 | Direct Bergen→Bodo, ~$100–200 |
| C&E/J&S onward flights | Fewer options from Alesund | Many options from Bergen |
| Trip arc | Builds toward drama | Starts with drama, winds down |

**Our lean:** Southbound (Alesund → Bergen) is probably the better call. The longer inbound flight is a shared hassle you deal with once. Splitting from Bergen is easier for everyone, especially P&L getting to Lofoten.

---

## Strengths

- You see both Sognefjord AND Geirangerfjord — the two most iconic fjord landscapes
- Trollstigen pass is a once-in-a-lifetime drive (if open)
- Alesund is a beautiful, underrated stop — Art Nouveau architecture, great aquarium, puffin islands
- One-way road trip means maximum variety, no repeated scenery
- Runde puffin island is a genuine wildlife highlight

## Tradeoffs

- More driving overall than Option A
- One-way car rental has drop-off fees
- You skip Hardangerfjord and Trolltunga entirely
- Trollstigen may still be closed in early-mid June (usually opens late May, but snow years can delay)

---

## Rough cost signals

- Flights SFO → Bergen: $800–1,200; SFO → Alesund: $900–1,400
- One-way car rental with drop-off fee: ~$100–150/day per car
- Accommodation: Bergen/Alesund hotels $150–250/night; fjord-area lodges $120–300/night
- P&L Lofoten flight: $100–200 from Bergen, $150–300 from Alesund (via Oslo)
